...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ArrayList<Integer> calibrationValues = getCalibrationValuesFromFile(
      fileName,
      numberMap
    );
    int sum = 0;
  ...
  private static ArrayList<Integer> getCalibrationValuesFromFile(
    String inputFile,
    ...
    for (int i = 0; i < scrambledValues.size(); i++) {
      calibrationValues.add(
        Integer.parseInt(
          "" +
          getFirstDigit(scrambledValues.get(i), numberMap) +
          getLastDigit(scrambledValues.get(i), numberMap)
        )
      );
    }
  ...
  private static ArrayList<String> getScrambledValuesFromFile(String inputFile)
    throws Exception {
